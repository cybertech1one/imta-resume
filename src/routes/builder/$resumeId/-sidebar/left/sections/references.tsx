...
const referencePresets = [
	{
		...
		description: "Référence professionnelle de l'encadrant de stage en entreprise",
	},
	{
		name: "Professeur Principal",
		position: "Enseignant IMTA / OFPPT",
		description: "Référence académique du professeur principal ou coordinateur de formation",
	},
	{
		name: "Directeur de Formation",
		position: "Responsable pedagogique",
		description: "Référence académique du directeur de formation ou chef de département",
	},
	{
		name: "Superviseur Clinique",
		position: "Infirmier(e) Chef / Cadre de sante",
		description: "Référence professionnelle du superviseur lors des stages hospitaliers",
	},
	{
		name: "Chef d'Équipe",
		position: "Responsable de production / Technicien senior",
		description: "Référence professionnelle du responsable d'équipe industrielle",
	},
	{
		name: "Responsable HSE",
		position: "Responsable Hygiène Sécurité Environnement",
		description: "Référence professionnelle du responsable HSE de l'entreprise d'accueil",
	},
	{
		name: "Références sur demande",
		position: "",
