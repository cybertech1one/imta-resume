---
name: resume-builder
description: Generate professional resumes that conform to the IMTA Resume schema. Use when the user wants to create, build, or generate a resume through conversational AI, or asks about resume structure, sections, or content. This skill guides the agent to ask clarifying questions, avoid hallucination, and produce valid JSON output for https://imta.ma.
---

# Resume Builder for IMTA Resume

Build professional resumes through conversational AI for [IMTA Resume](https://imta.ma), a free and open-source resume builder.
...
Output must conform to the IMTA Resume schema. See [references/schema.md](references/schema.md) for the complete schema structure.
...
When generating the resume, output a complete JSON object that conforms to the IMTA Resume schema. The user can then import this JSON directly into IMTA Resume at https://imta.ma.
